...
def check_miab_version(env, output):
	...
	if config.get("privacy", True):
		...
		if this_ver[0:3] == latest_ver[0:3]:
			...
			output.print_error(f"A new version of upstream project is available. You are running version {this_ver}. The latest version is {latest_ver}. For upgrade, go to github.com/aiutopcamico/debian-mailinabox and verify if a new version is available. ")
	# END AiutoPcAmico modification
