...
# 127.255.255.254 ("public DNS not supported"). We add forward-only zones with
# empty forwarders so bind9 resolves these domains directly (recursively)
...
// Exception zones for Spamhaus DNSBL — resolve directly, bypass forwarders.
// This prevents 127.255.255.254 ("public DNS") responses.
